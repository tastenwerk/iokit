...
iokit.loaderHtml = '<div class="loader"><div class="circle" /><div class="circle" /><div class="circle" /><div class="circle" /><div class="circle" /></div>';

iokit.setupTranslations = function setupTranslations(){
  $('.i18n').each( function(){
    $(this).text( $.i18n.t($(this).attr('data-i18n')) );
  });
};

iokit.setupAjaxHelpers = function setupAjaxHelpers(){
 ...
 * closes the modal.
 */
iokit.modal = function( html, options ){
...
iokit.fineUploaderText = function fineUploaderText(){
  return {
